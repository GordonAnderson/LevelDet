...
// General commands
  ...
  {"GTWIADD",  CMDint, 0, (char *)&leveldet.TWIadd},                      // Report the current TWI addess
  {"STWIADD",  CMDint, 1, (char *)&leveldet.TWIadd},                      // Set the TWI address
// LevelDet commands
  {"TARE", CMDfunction, 0, (char *)TareADC},                              // Sets the current ADC count as zero. This command
                                                                          // only affect the ReadADC function.
  {"RADCRAW", CMDint, 0, (char *)&LastADCval},                            // Read last raw ADC reading
  {"RADC", CMDfunction, 0, (char *)ReadADC},                              // Read last ADC reading and apply calibration
  {"SMODE", CMDint, 1, (char *)&leveldet.ADCmode},                        // Sets ADC mode, 
                                                                          //           0 = No window mode
                                                                          ...
                                                                          //           5 = ADC value changed
  {"GMODE", CMDint, 0, (char *)&leveldet.ADCmode},                        // Returns the current ADC mode
  {"STHRES", CMDint, 1, (char *)&leveldet.Threshold},                     // Sets ADC change threshold in ADC counts
  {"GTHRES", CMDint, 0, (char *)&leveldet.Threshold},                     // Returns ADC change threshold in ADC counts
  {"SSNUM", CMDint, 1, (char *)&leveldet.sampleNum},                      // Sets ADC sample number
  {"GSNUM", CMDint, 0, (char *)&leveldet.sampleNum},                      // Returns ADC sample number
  {"SPRES", CMDint, 1, (char *)&leveldet.preScaler},                      // Sets ADC prescaler number
  {"GPRES", CMDint, 0, (char *)&leveldet.preScaler},                      // Returns ADC prescalermple number
  {"SMUX", CMDint, 1, (char *)&leveldet.muxPos},                          // Sets ADC mux position, 6 or 7, 6 = default
  {"GMUX", CMDint, 0, (char *)&leveldet.muxPos},                          // Returns ADC mux position, 6 or 7, 6 = default
  {"SUPPER", CMDfunctionStr, 1, (char *)SetUpper},                        // Sets Upper limit in volts
  {"GUPPER", CMDfunction, 0, (char *)GetUpper},                           // Returns Upper limit in volts
  {"SLOWER", CMDfunctionStr, 1, (char *)SetLower},                        // Sets Lower limit in volts
  {"GLOWER", CMDfunction, 0, (char *)GetLower},                           // Returns Lower limit in volts
  {"SMON", CMDbool, 1, (char *)&MonitorFlag},                             // Sets monitor flag, if TRUE changes are reported to host
  {"GMON", CMDbool, 0, (char *)&MonitorFlag},                             // Returns monitor flag, if TRUE changes are reported to host
  {"SZP", CMDfunctionStr, 1, (char *)SetZeroPoint},                       // Sets the zero point value
  {"GZP", CMDfloat, 0, (char *)&leveldet.ZPV},                            // Returns the zero point value
// Lookup table commands
  {"STMODE", CMDint, 1, (char *)&leveldet.Tmode},                         // Sets the current Lookup table mode,0=Off, 1 = use ADC counts, 2 = use Calibrated results
  {"GTMODE", CMDint, 0, (char *)&leveldet.Tmode},                         // Returns the current Lookup table mode
  {"STBLENTRY", CMDfunctionLine, 1, (char *)SetTableEntry},               // Define lookup table entry. parms index, Lookup value, ADCvalue
  {"GTBLENTRY", CMDfunction, 1, (char *)GetTableEntry},                   // Return lookup table entry. Lookup value, ADCvalue
  {"LOOKUP", CMDfunction, 0, (char *)Lookup},                             // Return lookup value
// Calibration functions
  {"CALMON",  CMDfunction, 0, (char *)CalibrateMonitor},                  // Calibrate monitor input
  {"CALZP",  CMDfunction, 0, (char *)CalibrateZeroPoint},                 // Calibrate ZeroPoint
// End of table marker
  {0},
};
...
// - This function was developed for the FAIMSFB module using the M0 processor in 48 pin package.
// - port A bit 31 is tied low, physical pin 46 on FAIMSFB module.
...
void LoadAltRev(void)
{
   ...
   // Read the input pin, exit if high
